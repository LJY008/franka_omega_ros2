...
class JointImpedanceMoveItControllerG : public controller_interface::ControllerInterface {
public:
  JointImpedanceMoveItControllerG();
  ~JointImpedanceMoveItControllerG() override;
